    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                ...
                <td class="col-2">src="${SERVER_URL}images/categorias/${row.categoria_imagen}"</td>
                <td class="col-2"> 
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-3 editar"> <img src="../../resources/svg/editar.svg" alt="" />
                            </div>
                            <div class="col-3 eliminar"> <img src="../../resources/svg/eliminar.svg" alt="" />
                            </div>
                        </div>
                    </div>
                </td>
