...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    admin_cotraseña = document.getElementById('admin_cotraseña'),
    admin_correo = document.getElementById('admin_correo'),
    admin_estado = document.getElementById('admin_estado'),
    tipo_admin_id = document.getElementById('tipo_admin_id'),
    imagen_administrador = document.getElementById('imagen_administrador');
